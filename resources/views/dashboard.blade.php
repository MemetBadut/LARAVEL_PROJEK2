        ...
        <main :class="sidebarOpen ? 'ml-64' : 'ml-20'" class="flex-1 transition-all duration-300">
            ...
            <div class="p-8">
                    ...
                    <div class="flex items-end justify-between h-64 gap-2">
                        <template x-for="(height, index) in chartData" :key="index">
                            <div class="flex-1 flex flex-col items-center group cursor-pointer">
                                <div class="w-full bg-gradient-to-t from-indigo-600 to-indigo-400 rounded-t-lg transition-all group-hover:from-indigo-700 group-hover:to-indigo-500 relative"
                                    :style="`height: ${height}%`"
                ...
                <div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <button
                        class="bg-linear-to-br from-indigo-500 to-indigo-600 text-white p-4 rounded-lg hover:shadow-lg transition-all transform hover:-translate-y-1">
                        <i class="fas fa-plus-circle text-2xl mb-2"></i>
                        <p class="text-sm font-medium">Tambah Produk</p>
                    </button>
                    <button
                        class="bg-linear-to-br from-green-500 to-green-600 text-white p-4 rounded-lg hover:shadow-lg transition-all transform hover:-translate-y-1">
                        <i class="fas fa-file-download text-2xl mb-2"></i>
                        <p class="text-sm font-medium">Export Data</p>
                    </button>
                    <button
                        class="bg-linear-to-br from-purple-500 to-purple-600 text-white p-4 rounded-lg hover:shadow-lg transition-all transform hover:-translate-y-1">
                        <i class="fas fa-envelope text-2xl mb-2"></i>
                        <p class="text-sm font-medium">Kirim Email</p>
                    </button>
                    <button
                        class="bg-linear-to-br from-orange-500 to-orange-600 text-white p-4 rounded-lg hover:shadow-lg transition-all transform hover:-translate-y-1">
                        <i class="fas fa-bullhorn text-2xl mb-2"></i>
                        <p class="text-sm font-medium">Buat Promosi</p>
                    </button>
                </div>
            </div>
        </main>
