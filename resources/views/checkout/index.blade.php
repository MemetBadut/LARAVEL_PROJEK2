            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                            ...
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <div class="flex items-center space-x-2 mb-1">
                                        <span class="font-bold text-gray-900">{{ $defaultAddress->recipient_name }}</span>
                                        <span class="px-2 py-0.5 bg-blue-600 text-white text-xs font-semibold rounded">Main</span>
                                    </div>
                        ...
                        @else
                        <button class="w-full py-8 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition text-gray-500 hover:text-blue-600">
                            ...
                            <div class="flex items-start space-x-4">
                                <div class="w-20 h-20 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden flex-shrink-0">
                                    @if($item->product->gambar)
                                        <img src="{{ asset('storage/' . $item->product->gambar) }}" alt="{{ $item->product->nama }}" class="w-full h-full object-cover">
                                    @else
                                ...
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-900 mb-1">{{ $item->product->nama }}</h4>
                                    <p class="text-sm text-gray-500 mb-2">{{ $item->quantity }} item(s) × Rp {{ number_format($item->price, 0, ',', '.') }}</p>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        <label class="flex items-center justify-between p-4 border-2 border-blue-500 bg-blue-50 rounded-lg cursor-pointer">
                            <div class="flex items-center space-x-3">
                                <input type="radio" name="shipping" value="regular" checked class="w-5 h-5 text-blue-600">
                                <div>
                        ...
                        <label class="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-300 transition">
                            <div class="flex items-center space-x-3">
                        ...
                        <label class="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-300 transition">
                            <div class="flex items-center space-x-3">
                                <input type="radio" name="shipping" value="same-day" class="w-5 h-5 text-blue-600">
                                <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <details class="group border border-gray-200 rounded-lg">
                                ...
                                <div class="px-4 pb-4 space-y-2">
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="gopay" class="w-4 h-4 text-blue-600">
                                        <span class="ml-3 flex items-center">
                                            <span class="font-semibold text-green-600 mr-2">GoPay</span>
                                        </span>
                                    </label>
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="ovo" class="w-4 h-4 text-blue-600">
                                        <span class="ml-3 flex items-center">
                                            <span class="font-semibold text-purple-600 mr-2">OVO</span>
                                        </span>
                                    </label>
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="dana" class="w-4 h-4 text-blue-600">
                                        <span class="ml-3 flex items-center">
                            ...
                            <details class="group border border-gray-200 rounded-lg">
                                ...
                                <div class="px-4 pb-4 space-y-2">
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="bca" class="w-4 h-4 text-blue-600">
                                        <span class="ml-3 font-semibold text-gray-900">BCA Virtual Account</span>
                                    </label>
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="mandiri" class="w-4 h-4 text-blue-600">
                                        <span class="ml-3 font-semibold text-gray-900">Mandiri Virtual Account</span>
                                    </label>
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300">
                                        <input type="radio" name="payment" value="bni" class="w-4 h-4 text-blue-600">
                            ...
                            <label class="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-300 transition">
                                <div class="flex items-center space-x-3">
                                    <input type="radio" name="payment" value="credit-card" class="w-5 h-5 text-blue-600">
                            ...
                            <label class="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-300 transition">
                                <div class="flex items-center space-x-3">
                                    <input type="radio" name="payment" value="cod" class="w-5 h-5 text-blue-600">
                                    <div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 sticky top-4">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            <button class="w-full flex items-center justify-between p-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition">
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            ...
                            {{-- Place Order Button --}}
                            <button class="w-full bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-4 rounded-lg font-bold text-lg transition transform hover:scale-105 shadow-lg">
                                Place Order
                            </button>
