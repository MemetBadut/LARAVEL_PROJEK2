...
@section('content')
    <div
        class="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full">
            <!-- Logo & Title -->
            <div class="text-center mb-8">
                <div
                    class="w-20 h-20 bg-linear-to-br from-blue-600 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                <p class="mt-2 text-gray-600">Login untuk melanjutkan belanja</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <!-- Login Button -->
                    <button type="submit"
                        class="w-full bg-linear-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition transform hover:scale-105 shadow-lg">
                        Login
                    </button>
